...
def test_track_segments_splits_on_gap_and_drops_positionless():
    positions = [
        {"lat": 51.5, "lon": -0.1, "altitude": 1500, "timestamp": "2026-06-16T00:00:00+00:00"},
        {"lat": 51.51, "lon": -0.1, "altitude": 1500, "timestamp": "2026-06-16T00:01:00+00:00"},
        {"gap": True, "timestamp": "2026-06-16T00:40:00+00:00"},
        {"altitude": 1500, "timestamp": "2026-06-16T00:45:00+00:00"},  # no lat/lon -> dropped
        {"lat": 51.52, "lon": -0.1, "altitude": 1500, "timestamp": "2026-06-16T00:46:00+00:00"},
        {"lat": 51.53, "lon": -0.1, "altitude": 1500, "timestamp": "2026-06-16T00:47:00+00:00"},
    ]
...
def test_resolve_reference_env_home_wins():
    env = {"AIR_HOME_LAT": "51.5", "AIR_HOME_LON": "-0.1"}
    assert g.resolve_reference({"lat": 1.0, "lon": 2.0}, env=env) == (51.5, -0.1)


def test_resolve_reference_falls_back_to_gps():
    assert g.resolve_reference({"lat": 51.5, "lon": -0.1}, env={}) == (51.5, -0.1)
